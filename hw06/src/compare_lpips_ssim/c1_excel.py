...
# 使用您提供的路徑
folder_path = 'D:/graduate/113.2/CT/ct2024s/hw06/src/compare_lpips_ssim/chen'
my_handwriting_path = 'D:/graduate/113.2/CT/ct2024s/hw06/src/compare_lpips_ssim/chen/112598084.jpg'

# 比較手寫字圖片並生成表格
df = compare_handwritings(folder_path, my_handwriting_path)
print(df)

output_csv_path = 'D:/graduate/113.2/CT/ct2024s/hw06/src/compare_lpips_ssim/chen/result.csv'
